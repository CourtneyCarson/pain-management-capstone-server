...
VALUES
  ...
  (9,'Ruby Red Slippers', 'https://loremflickr.com/750/300/landscape?random=9',  'Get home quicker than either Uber or Lyft! Three taps of the heels is all it takes. One size fits all.'),
  (10,'Magic Lamp', 'https://loremflickr.com/750/300/landscape?random=10', 'May or may not produce a genie.');
